...
NICKNAME CHAR(50),
BIO CHAR(50),
FAVORITE_MUSIC CHAR(50),
FAVORITE_COLOUR CHAR(50),
PHOTO TEXT,
UNIQUE(TELEGRAM_ID)
)
"""
...
UPDATE profiles SET NICKNAME =?,BIO =?,FAVORITE_MUSIC =?,FAVORITE_COLOUR =? ,PHOTO =?WHERE TELEGRAM_ID = ?
...
SELECT REFERENCE FROM reference WHERE TELEGRAM_ID =?
"""
